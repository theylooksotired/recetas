...
class Recipe_Form extends Form
{
    ...
    {   
        $updatedSpan = $this->object->updatedSpan();
        $buttonApi = ($this->object->id() != '') ? '
            ' . (($updatedSpan != '') ? $updatedSpan . '<br/><br/>' : '') . '
            ...
            <a class="button button_small" target="_blank" href="' . url('recipe/seo-advice/' . $this->object->id(), true) . '">Consejos SEO</a>
