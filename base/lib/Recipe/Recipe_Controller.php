    ...
    public function getContent()
    {
        ...
        switch ($this->action) {
            ...
            case 'full-ai-recipe':
                ...
                if ($content != '') {
                    $questionRecipe = 'Escribe un archivo JSON, sin ningun texto adicional, con los campos titulo, metaDescripcion (140 caracteres), descripcion (350 caracteres), descripcionHtml (descripcion sencilla del plato, de maximo 1000 caracteres en codigo HTML), ingredientes (lista, separar cada ingrediente si una linea tiene varios), pasos (lista, que incluya a todos los ingredientes, siempre en tercera persona y con un lenguaje muy amigable). La receta es: "' . $content . '"';
