    ...
    public function getContent()
    {
        ...
        switch ($this->action) {
            ...
            case 'add-recipe-ai':
                ...
                if ($content != '') {
                    $questionRecipe = 'Escribe un archivo JSON en español (traduce desde cualquier idioma si es necesario), sin ningun texto adicional, con los campos titulo (que debe ser obligatoriamente traducido al español), metaDescripcion (140 caracteres), descripcion (350 caracteres), descripcionHtml (descripcion sencilla del platodebe ser distinta a la descripcion, como la forma de preparacion la receta u algun dato interesante de la misma, de maximo 1000 caracteres en codigo HTML), idCategoria (' . $categoriesString . '), numeroPorciones (el número estimado de porciones), tiempoPreparacion (debe ser uno de estos valores: "5_minutes", "30_minutes", "45_minutes", "1_hour", "2_hours", "3_hours", "4_hours", "5_hours", "1_day", "2_days"), metodoPreparacion (debe ser uno de estos valores: "", "fried", "steamed", "boiled", "baked", "grilled"), ingredientes (lista, separar cada ingrediente si una linea tiene varios, no olvidar que tienen que estar en español), pasos (lista, que incluya a todos los ingredientes, siempre en tercera persona y con un lenguaje muy amigable, se debe tener una sola linea por paso). La receta es: "' . $content . '"';
